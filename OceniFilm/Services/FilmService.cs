    ...
    public class FilmService : IFilmService
    {
        ...
        public async Task<IEnumerable<Film>> GetFilmiAsync()
        {
            try
            {
                ...
                return await _httpClient.GetFromJsonAsync<IEnumerable<Film>>(_configuration["VideotekaService"] + "api/Videoteka");
            }
        ...
        public async Task<Film> GetFilmByTitleAsync(string naslovFilma)
        {
            try
            {
                ...
                return await _httpClient.GetFromJsonAsync<Film>(_configuration["VideotekaService"] + "api/Videoteka/film/" + naslovFilma);
            }
            catch (HttpRequestException)
            {
                return new Film();
