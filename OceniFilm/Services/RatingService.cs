    ...
    public class RatingService : IRatingService
    {
        ...
        public async Task<Ocena> GetOcenaByTitleAndUserAsync(string naslovFilma, string prikaznoIme)
        {
            try
            {
                ...
                return await _httpClient.GetFromJsonAsync<Ocena>(_configuration["OcenjevanjeService"] + "poFilmuInUporabniku/" + naslovFilma + "/" + prikaznoIme);
            }
        ...
        public async Task<HttpResponseMessage> CreateRatingAsync(Ocena ocena)
        {
            try
            {
                ...
                return await _httpClient.PostAsJsonAsync(_configuration["OcenjevanjeService"] + "api/Ocena", ocena);
            }
            catch (HttpRequestException)
            {
        ...
        public async Task<HttpResponseMessage> EditRatingAsync(Ocena ocena)
        {
            try
            {
                ...
                return await _httpClient.PutAsJsonAsync(_configuration["OcenjevanjeService"] + "api/Ocena", ocena);
            }
            catch (HttpRequestException)
            {
                return new HttpResponseMessage(HttpStatusCode.BadRequest);
