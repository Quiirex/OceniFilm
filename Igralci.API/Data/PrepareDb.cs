        ...
        if (!database.Igralci.Any())
        {
            ...
            database.Igralci.AddRange(
                ...
                new Igralec
                {
                    ...
                    SeznamFilmov = new List<IgraniFilm>
                    {
                        new() {Naslov = "Call Me by Your Name"},
                        new() {Naslov = "Lady Bird"},
                        new() {Naslov = "Beautiful Boy"},
                        new() {Naslov = "Little Women"},
                        new() {Naslov = "Dune"}
                    }
                },
                new Igralec
                {
                    ...
                    SeznamFilmov = new List<IgraniFilm>
                    {
                        new() {Naslov = "Spider-Man: Homecoming"},
                        new() {Naslov = "Spider-Man: Far From Home"},
                        new() {Naslov = "The Impossible"},
                        new() {Naslov = "The Devil all the Time"},
                        new() {Naslov = "Captain America: Civil War"}
                    }
                },
                new Igralec
                {
                    ...
                    {
                        new() {Naslov = "Iron Man"},
                        new() {Naslov = "Sherlock Holmes"},
                        new() {Naslov = "Tropic Thunder"},
                        new() {Naslov = "Zodiac"},
                        new() {Naslov = "The Nice Guys"}
                    }
                },
                new Igralec
                {
                ...
                new Igralec
                {
                    ...
                    Biografija =
                        "Je edini otrok Avnerja Hershlaga, v Izraelu rojenega zdravnika, in Shelley Stevens, v ZDA rojene umetnice (iz Cincinnatija v Ohiu), ki je tudi Natalijina agentka. Njena starša sta aškenazijskega judovskega porekla. Natalijina družina se je iz Izraela preselila v Washington, D.C., ko je bila Natalie še zelo majhna. Po nekaj selitvah se je družina končno ustalila v New Yorku, kjer živi še danes. Maturirala je z odliko, njeni akademski dosežki pa so ji omogočili študij na univerzi Harvard. Pri 11 letih jo je v piceriji odkril agent. Nagovarjal jo je k manekenski karieri, vendar se je odločila, da se bo raje posvetila igralski karieri. Nastopila je v številnih nastopih v živo, v filmu Léon pa je debitirala v močni filmski vlogi: (1994) (tudi \"Léon\"). Po tej vlogi je Natalie dobila vloge v filmih, kot so Vročina (1995), Lepa dekleta (1996) in Mars napada! (1996).",
                    Fotografija =
                        "https://media.vanityfair.com/photos/5e4563b4609b5f0008cf47bc/master/pass/GettyImages-1205162493.jpg",
                    SeznamFilmov = new List<IgraniFilm>
                    {
                        new() {Naslov = "Black Swan"},
                        new() {Naslov = "V for Vendetta"},
                        new() {Naslov = "Leon: The Professional"},
                        new() {Naslov = "Closer"},
                        new() {Naslov = "Thor"}
                    }
                },
